...
//    if(image.size.height > image.size.width &&  image.size.height > 1024){
//        return [ImageUtility imageWithImageSimple:image scaledToSize:CGSizeMake(1024*image.size.width/image.size.height, 1024)];
//    }
//    
//    if(image.size.width > image.size.height &&  image.size.width > 1024){
//        return [ImageUtility imageWithImageSimple:image scaledToSize:CGSizeMake(1024, 1024*image.size.height/image.size.width)];
//    }
