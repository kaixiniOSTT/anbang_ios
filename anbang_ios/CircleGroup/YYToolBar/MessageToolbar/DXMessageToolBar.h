...
@interface DXMessageToolBar : UIView<UIGestureRecognizerDelegate,AVAudioRecorderDelegate>

@property (nonatomic, weak) id <DXMessageToolBarDelegate> delegate;


@property (nonatomic, strong) NSString * isToalAction;
 ...
 *  表情的附加页面
 */
@property (strong, nonatomic) ZBMessageManagerFaceView *faceView;
 ...
 *  松开手指完成录音
 */
- (void)didFinishRecoingVoiceAction:(NSString *)vedioUrl time:(float)interl;
/**
