//
//  AddContactsResultViewController.h
//  anbang_ios
//
...
@interface AddContactsResultViewController : UIViewController<UITableViewDataSource,UITableViewDelegate,UIActionSheetDelegate >{
