...
- (void)layoutAssets
{
    ...
    float imageSizeWH = (KCurrWidth-20)/4;
   // float imageMargin = (20+(KCurrWidth-20)%4)/5;
    
    
    CGRect rect = (CGRect){
      //  PHOTO_THUMBNAIL_DEFAULT_MARGIN, PHOTO_THUMBNAIL_DEFAULT_MARGIN, PHOTO_THUMBNAIL_DEFAULT_SIZE
         PHOTO_THUMBNAIL_DEFAULT_MARGIN, PHOTO_THUMBNAIL_DEFAULT_MARGIN, imageSizeWH,imageSizeWH
    };
