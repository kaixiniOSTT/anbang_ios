...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    ...
    if (!cell) {
        cell = [[BBTableViewCell alloc] initWithStyle:UITableViewCellStyleSubtitle reuseIdentifier:ID];
    }
...
- (void)layoutSubviews {
    ...
    self.imageView.frame = CGRectMake(Margin_To_Left, Margin_To_Top_Bottom - 6, 29, 29);
