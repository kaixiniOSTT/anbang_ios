...
@interface AddressBookViewController2 : UIViewController<UITableViewDataSource,UITableViewDelegate,UISearchBarDelegate,MFMessageComposeViewControllerDelegate>
{
    sqlite3 *database;
    //判断来自哪个view
