...
#define kDefaultOverlayColor [UIColor redColor]
...
#define kShadowColor [UIColor colorWithWhite:1.0f alpha:kShadowOpacity]
#define kShadowRadius 1.0f

#define kBadgeHeight 18.0f
#define kBadgeTextSideMargin 10.0f

#define kBadgeCornerRadius 9.0f
...
@property (atomic, retain) UIView *parent;
...
- (void)layoutSubviews
{
    ...
    switch (self.badgeAlignment) {
        ...
        case JSBadgeViewAlignmentTopRight:
            ...
            newFrame.origin.y = -viewHeight / 2.0f;
            break;
        case JSBadgeViewAlignmentTopRigthCustom:
            newFrame.origin.x = superviewWidth - (viewWidth / 2.0f)+2;
            newFrame.origin.y = (-viewHeight / 2.0f)+5;
            break;
        case JSBadgeViewAlignmentTopRigthCustom2:
            newFrame.size.width = viewWidth;
            newFrame.size.height = viewHeight-2;
            newFrame.origin.x = superviewWidth - (viewWidth / 2.0f)-70;
        ...
        case JSBadgeViewAlignmentCenterRight:
            newFrame.origin.x = superviewWidth - (viewWidth / 2.0f)-20;
